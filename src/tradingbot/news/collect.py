...
This is what the weekend workflow and the ``tradingbot news`` CLI both run.
...
from tradingbot.news import feeds, store, tickers
from tradingbot.news.signal import (
