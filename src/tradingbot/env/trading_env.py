...
from tradingbot.config import ActionSpaceKind, EnvConfig
from tradingbot.execution import ExecutionModel, MarketContext
from tradingbot.portfolio import Portfolio
from tradingbot.rewards import build_reward
...
class TradingEnv(gym.Env):
    """Single-asset trading environment over daily bars.
    ...
    def __init__(
        ...
        *,
        ...
        if bars["symbol"].n_unique() > 1:
            raise ValueError("TradingEnv handles one symbol; got several")
