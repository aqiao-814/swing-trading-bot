...
from tradingbot.agents.baselines import Agent
from tradingbot.config import EnvConfig
from tradingbot.env.trading_env import EpisodeResult, TradingEnv
from tradingbot.metrics import PerformanceReport, build_report


def run_episode(env: TradingEnv, agent: Agent, *, seed: int | None = None) -> EpisodeResult:
...
def evaluate(
    ...
    *,
    ...
    """
    env = TradingEnv(dataset, feature_cols, cfg, random_start=False)
