...
from swingbot.nautilus.instruments import share_qty
from swingbot.nautilus.signals import (
    DEFAULT_ALPHA,
    DEFAULT_NEWS,
    DEFAULT_SIZING,
    AlphaConfig,
...
class SwingbotV2(Strategy):
    """Cross-sectional long/short, vol-targeted, held overnight, no kill switch."""
